...
const Footer = () => (
    <footer className="footer" style={{
        ...
        <div className="content has-text-centered">
         ...
         Created by <a className="has-text-dark has-text-weight-semibold" href="https://mirelescommunications.com" aria-label="Mireles Communications" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>Mireles Communications</a>
         {' '} in the {' '}
